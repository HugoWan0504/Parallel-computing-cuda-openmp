[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/5fyyA_mv)
# project1-sorting  
...
```bash
numactl -i all ./quicksort [test_case] [num_elements] [num_rounds] [random_seed]  
```
If not specified, the default values are ``test_case=1``, ``num_elements=100000000``, ``num_rounds=3`` and ``random_seed=1``.  
...
+ Pre-allocate memory. It's not recommended to do memory allocation in parallel.  
